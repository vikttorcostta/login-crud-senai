...
<body class="bg-gray-100 h-screen flex overflow-hidden">
    ...
    var exampleData = [
        ...
        {id: 2, nome: "Maria Santos", email: "maria@email.com", telefone: "(21) 98765-1234", cpf: "987.654.321-00"},
        {id: 3, nome: "Pedro Oliveira", email: "pedro@email.com", telefone: "(31) 91234-5678", cpf: "456.789.123-00"},
        {id: 4, nome: "Ana Rodrigues", email: "ana@email.com", telefone: "(41) 99876-5432", cpf: "789.123.456-00"},
        {id: 5, nome: "Carlos Ferreira", email: "carlos@email.com", telefone: "(51) 95678-1234", cpf: "321.654.987-00"},
        {id: 6, nome: "Juliana Lima", email: "juliana@email.com", telefone: "(61) 94321-8765", cpf: "654.987.321-00"},
        {id: 7, nome: "Roberto Almeida", email: "roberto@email.com", telefone: "(71) 93456-7890", cpf: "159.753.852-00"},
        {id: 8, nome: "Fernanda Costa", email: "fernanda@email.com", telefone: "(81) 92345-6789", cpf: "753.159.852-00"},
        {id: 9, nome: "Marcelo Souza", email: "marcelo@email.com", telefone: "(91) 91234-5678", cpf: "852.963.741-00"},
        {id: 10, nome: "Luciana Martins", email: "luciana@email.com", telefone: "(12) 99876-5432", cpf: "369.258.147-00"}
    ];
    ...
    $(document).ready(function() {
        ...
        function updateUser(id, userData) {
            var index = exampleData.findIndex(u => u.id === id);
            if (index !== -1) {
    ...
    function viewUser(id) {
        var user = exampleData.find(u => u.id === id);
        if (user) {
            var detailsHtml = `
